...
**Docs:** [Report](https://github.com/Danielmark001/sc2002-btoms/blob/main/SC2002-Project-Report.pdf) | 
...
[Java Docs](https://Danielmark001.github.io/sc2002-btoms/sc2002_btoms/module-summary.html)
...
3. Run the following command in the terminal:
   ...
   ```bash
    javadoc -d docs -author -private -noqualifier all -version -sourcepath src -subpackages controllers:enumeration:interfaces:main:models:services:stores:utils:view
   ```
